...
1) Преву. часть повторить по уроку
...
"Ваш любымый жанр под номерм ${номер по порядку}". 
Каждый ответ записывается в массиы данных genres
...
function writeYourGenres() {
  for (let i = 1; i <= 3; i++) {
    personalMovieDB.genres[i - 1] = prompt(`Ваш любымый жанр под номерм ${i}`, '');;
  }
}
